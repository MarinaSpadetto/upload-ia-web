        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="transcription_prompt" className="h-20 leading-relaxed resize-none" placeholder="Inclua palavras-chaves mencionadas no video separadas por vírgula (,)"/>
            </div>
